...
values
  ...
  ('Zara', 'zara', 'acid', 'Fast-moving fashion, broad silhouette range. 7 pieces in the FITCHECK catalogue.', 'https://www.zara.com', true),
  ('A.P.C.', 'apc', 'violet', 'French minimalism and raw denim, unchanged since 1987. 6 pieces in the FITCHECK catalogue.', 'https://www.apc.fr', true),
  ('Norse Projects', 'norseprojects', 'tomato', 'Scandinavian utility with a considered palette. 5 pieces in the FITCHECK catalogue.', 'https://www.norseprojects.com', true),
  ('Sunspel', 'sunspel', 'forest', 'English cotton, made in Long Eaton since 1860. 6 pieces in the FITCHECK catalogue.', 'https://www.sunspel.com', true),
  ('H&M', 'hm', 'acid', 'Wide colour range across every category. 6 pieces in the FITCHECK catalogue.', 'https://www.hm.com', true),
  ('Massimo Dutti', 'massimodutti', 'violet', 'Tailored, muted, quietly premium. 6 pieces in the FITCHECK catalogue.', 'https://www.massimodutti.com', true)
